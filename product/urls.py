...
from .views import ProductList, ProductCreate, ProductUpdate, ProductDelete, CategoryList, CategoryCreate, CategoryUpdate, CategoryDelete,ProductDetail,HomepageProducts, ProductSearch
